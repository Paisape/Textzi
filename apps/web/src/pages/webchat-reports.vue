...
async function load() {
  ...
  loadError.value = ''
  try {
    reports.value = await $api<Reports>('/v1/webchat/reports', { params: { days: days.value } })
  }
  catch (error: any) {
      ...
      <VCol cols="6" sm="4" md="2">
        <VCard>
          <VCardText>
            ...
            <p class="text-h5 mb-0">
              {{ formatMinutes(reports.avg_first_response_minutes) }}
            </p>
          </VCardText>
        </VCard>
      </VCol>
      <VCol cols="6" sm="4" md="2">
        <VCard>
          <VCardText>
            ...
            <p class="text-h5 mb-0">
              {{ formatMinutes(reports.avg_resolution_minutes) }}
            </p>
          </VCardText>
        </VCard>
      </VCol>
      ...
      <VCol cols="6" sm="4" md="3">
        <VCard>
          <VCardText>
            ...
            <p class="text-h5 mb-0" :class="reports.resolution_breached_count ? 'text-error' : ''">
              {{ reports.resolution_breached_count }}
            </p>
          </VCardText>
        </VCard>
      </VCol>
