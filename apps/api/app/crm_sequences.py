...
router = APIRouter(prefix="/v1/crm", tags=["crm-sequences"], dependencies=[Depends(require_channel_scope("crm")), Depends(require_page_scope_for("crm-automation")), Depends(require_plan_feature("crm", "crm-automation"))])
